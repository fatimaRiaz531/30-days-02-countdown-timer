...
export default function Countdown() {
  ...
  return (
    ...
    <div  style={{
      backgroundImage: 'url(https://media.gettyimages.com/id/1339006822/photo/alarm-clock-on-orange-color-background.jpg?s=612x612&w=0&k=20&c=xBJw_QdX0En8e9lPohjfyzAp4s4o68cdHsgXQCm6Y8Q=)', // Path to your image
  ...
  >
      {/* Timer box container */}
      <div className="bg-orange-300 dark:bg-gray-800 shadow-lg rounded-lg p-8 w-full max-w-md">
        {/* Title of the countdown timer */}
        <h1 className="text-2xl font-bold mb-4 text-gray-800 dark:text-gray-700 text-center">
          Countdown Timer
        </h1>
        ...
        <div className="flex items-center mb-6">
          <Input
            ...
            className="flex-1 mr-4 rounded-md text-black border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-200"
          />
          <Button
